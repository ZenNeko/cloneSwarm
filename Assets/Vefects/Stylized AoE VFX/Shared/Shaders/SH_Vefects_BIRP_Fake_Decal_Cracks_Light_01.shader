...
Shader "Vefects/SH_Vefects_BIRP_Fake_Decal_Cracks_Light_01"
{
    ...
    SubShader
    {
            ...
            void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float screenDepth368 = LinearEyeDepth(SampleSceneDepth(ase_screenPosNorm.xy ), _ZBufferParams);
			float distanceDepth368 = saturate( ( screenDepth368 - LinearEyeDepth( ase_screenPosNorm.z , _ZBufferParams) ) / ( _FakeDecalDepthFade ) );
