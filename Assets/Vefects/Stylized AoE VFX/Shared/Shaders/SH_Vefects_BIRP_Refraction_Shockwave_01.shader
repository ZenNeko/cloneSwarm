...
Shader "Vefects/SH_Vefects_BIRP_Refraction_Shockwave_01"
{
    ...
    SubShader
    {
            ...
            void surf( Input i , inout SurfaceOutput o )
		{
			...
			float screenDepth71 = LinearEyeDepth(SampleSceneDepth(ase_screenPosNorm.xy ), _ZBufferParams);
			float distanceDepth71 = saturate( ( screenDepth71 - LinearEyeDepth( ase_screenPosNorm.z , _ZBufferParams) ) / ( i.uv_texcoord.w ) );
