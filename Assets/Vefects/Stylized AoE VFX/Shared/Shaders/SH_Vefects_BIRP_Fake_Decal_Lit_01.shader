...
Shader "Vefects/SH_Vefects_BIRP_Fake_Decal_Lit_01"
{
    ...
    SubShader
    {
            ...
            void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float screenDepth125 = LinearEyeDepth(SampleSceneDepth(ase_screenPosNorm.xy ), _ZBufferParams);
			float distanceDepth125 = saturate( ( screenDepth125 - LinearEyeDepth( ase_screenPosNorm.z , _ZBufferParams) ) / ( _FakeDecalDepthFade ) );
