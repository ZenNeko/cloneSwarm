    ...
    SubShader
    {
            ...
            struct Input
		{
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float2 _Texture01UVPanSpeed;
                float2 _Texture01UVScale;
                float4 _Texture01Selector;
                float2 _Texture02UVPanSpeed;
                float2 _Texture02UVScale;
                float2 _DistortionUVPanSpeed;
                float2 _DistortionUVScale;
                float _DistortionAmount;
                float4 _Texture02Selector;
                float _LUTAmplitude;
                float _LUTOffset;
