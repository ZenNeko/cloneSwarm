...
namespace CloneSwarm.UI.P3R
{
    ...
    public class P3RMenuList : MonoBehaviour
    {
        ...
        /// <summary>ของยังบินเข้าอยู่ — อินพุตทุกทางถูกปฏิเสธ **เงียบๆ** ระหว่างนี้
        ///
        /// เปิดออกมาให้อ่านได้เพราะเทสต์อัตโนมัติต้องรอจังหวะนี้ให้จบก่อนกด
        /// ไม่งั้นจะกดแล้วไม่เกิดอะไร แล้วไปตกที่ปลายทางเหมือนจอเสีย</summary>
