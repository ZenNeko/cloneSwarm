...
namespace CloneSwarm.UI.P3R
{
    ...
    public class P3RTheme : ScriptableObject
    {
        ...
        [Tooltip("ตัวคูณขนาดของข้อความภาษาไทย\n\n" +
                 "ไทยไม่มีตัวพิมพ์ใหญ่ ความสูงที่ตาเห็นจึงเทียบเท่าตัวพิมพ์เล็กของละติน\n" +
                 "วางข้างคำ ALL-CAPS ที่ขนาดเท่ากันแล้วไทยจะดูเบากว่าเสมอ (English / ไทย)\n" +
                 "ขยายขึ้นเล็กน้อยให้น้ำหนักที่ตาเห็นใกล้กัน · 1 = ไม่ชดเชย")]
