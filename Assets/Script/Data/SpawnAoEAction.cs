...
[CreateAssetMenu(fileName = "SpawnAoEAction", menuName = "Boss/Actions/SpawnAoEAction")]
public class SpawnAoEAction : BossAction
{
    ...
    public override IEnumerator ExecuteCoroutine(NetworkBehaviour runner, GameObject telegraphPrefab)
    {
        ...
        {
            Debug.LogWarning("[SpawnAoEAction] telegraphPrefab is null!");
            yield break;
        }
    ...
    private List<Vector3> GetSpawnPositions(NetworkBehaviour runner)
    {
        ...
        switch (targetingMode)
        {
            ...
            case TargetingMode.StaticCoords:
                // อิงจุดกึ่งกลางแมปหรือออฟเซ็ตคงที่
