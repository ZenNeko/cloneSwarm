...
ยังไม่เจอเพดานเรื่อง**จำนวน** แต่เจอ **scope creep 2 ครั้ง** (Round 3 · Round 4)
รูปแบบเดียวกันทั้งคู่: เติมโค้ด "กันไว้ก่อน" ที่ไม่มีใครขอ ไม่ใช่เข้าใจงานผิด

**T20 ทำไม่ได้อย่างซื่อสัตย์ตอนนี้** — backlog จาก audit ถูกเก็บไปเกือบหมดใน Round 1-4
ของที่เหลือต้องแก้ `.asset`/`.prefab` (กฎห้าม) หรือยังไม่ชัดพอจะสั่งงาน
Round 5 เป็นของใหม่ทั้งหมดจาก hot-path sweep ได้ 10 ข้อจริง · ถ้าจะไป 20 ต้องหาของใหม่อีกรอบ
