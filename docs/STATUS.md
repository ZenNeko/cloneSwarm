...
| **7** | รอบฟีเจอร์ — เลขดาเมจลอย · solo ไม่นับถอยหลัง · ล้าง VFX key ตาย | 📋 **แผนพร้อม รอวางใน Antigravity** |
| 8+ | ยังไม่เขียน — ดู "แผนระยะยาว" ข้างล่าง | — |

**นับรวม: ทำไปแล้ว 5 รอบ (ครอบคลุมเลข 1-6 เพราะ 5+6 รวมเป็นรอบเดียว) · พร้อมส่ง 1 รอบ**
รวม **46 tasks · ~50 ครั้งที่แตะไฟล์** · Fix Round เกิดครั้งเดียว (Round 4 — แผนผิดเอง)
